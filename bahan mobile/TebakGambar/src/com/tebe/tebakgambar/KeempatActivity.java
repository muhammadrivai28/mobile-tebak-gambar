...
public class KeempatActivity extends Activity {
	EditText jawabanTxt;
	@Override
    ...
    public void cekJawaban(View v){
    	String jawabanBenar = "DRAKULA OMPONG";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),KelimaActivity.class);
    		startActivity(i);
    	}else{
    		// pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.keempat, menu);
		return true;
	}
